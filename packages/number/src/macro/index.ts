import { types as bt, parse, traverse, NodePath as bNodePath, Node as bNode } from "@babel/core"
...
const transformEReferences = (refs: bNodePath<bNode>[]) => {
...
const parseEArguments = (node: bNode) => doAndMapStringError(() => {
